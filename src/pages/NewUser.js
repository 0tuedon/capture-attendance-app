...
import { InputArray } from '../data/data'
...
const NewUser = () => {
  ...
  const filteredArrayProduct = InputArray
  console.log(product)
  return (
        <div>
            <div>
                <h1 className=' text-4xl sm:text-6xl font-semibold text-center'>Register A New User</h1>
            </div>
